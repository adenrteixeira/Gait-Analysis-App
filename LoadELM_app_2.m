function LoadELM_app_2(ELMPATH,PATHSAVE)

tabela = readtable('ForELM_app.csv');

nn = load(ELMPATH);

[nn1, acc_test]   = elm_test(table2array(tabela(1,[106,107,111]))', table2array(tabela(1,[2:102]))', nn);

path = PATHSAVE + "ResultsELMTeste.csv";
