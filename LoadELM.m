function LoadELM(GRF,ELMPATH,RELMPATH)

if(strcmp(GRF,'AP'))
    tabela = readtable('ForELMAndRELM_AP.csv');
    disp("Im in AP");
elseif(strcmp(GRF,'ML'))
    tabela = readtable('ForELMAndRELM_ML.csv');
    disp("Im in ML");
else
    tabela = readtable('ForELMAndRELM_V.csv');
    disp("Im in V");
end
