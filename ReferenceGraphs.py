...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_12.addWidget(self.checkBox_11, 5, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_11.setText(_translate("MainWindow", "OneOneOne"))
    ...
    def loadModels(self):
        ...
        if(self.horizontalSlider_6.value() == 0): # Is female
            if(self.horizontalSlider_7.value() == 0): # Its left foot 
                ...
                if(self.checkBox_11.isChecked()): # OneOneOne
                    OOO_model_AP = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_AP_Left')
                    OOO_model_ML = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_ML_Left')
                    OOO_model_V = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_V_Left')
                    
                    plt.plot(OOO_model_V.predict(np.array([self.spinBox_2.value(), self.horizontalSlider_5.value(), round(float(self.lineEdit_7.text()) / (float(self.lineEdit_8.text()) * float(self.lineEdit_8.text()) * 0.0001),1)]).reshape(1, -1)).flatten(), color="Orange", linestyle='-', marker ='p', markerfacecolor='black', label="OneOneOne V")
                    plt.plot(OOO_model_ML.predict(np.array([self.spinBox_2.value(), self.horizontalSlider_5.value(), round(float(self.lineEdit_7.text()) / (float(self.lineEdit_8.text()) * float(self.lineEdit_8.text()) * 0.0001),1)]).reshape(1, -1)).flatten(), color="Orange",linestyle='-', marker ='h', markerfacecolor='green', label="OneOneOne ML")
                    plt.plot(OOO_model_AP.predict(np.array([self.spinBox_2.value(), self.horizontalSlider_5.value(), round(float(self.lineEdit_7.text()) / (float(self.lineEdit_8.text()) * float(self.lineEdit_8.text()) * 0.0001),1)]).reshape(1, -1)).flatten(), color="Orange", linestyle='-', marker ='^', markerfacecolor='white', label="OneOneOne AP")
                    plt.legend()
                    self.canvas.draw()
                ...
                if(self.checkBox_11.isChecked()): # OneOneOne
                    OOO_model_AP = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_AP_Right')
                    OOO_model_ML = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_ML_Right')
                    OOO_model_V = keras.models.load_model('Results/OneOneOne/OneOneOne_Female_V_Right')
            ...
            if(self.horizontalSlider_7.value() == 0): # Its left foot 
                ...
                if(self.checkBox_11.isChecked()): # OneOneOne
                    OOO_model_AP = keras.models.load_model('Results/OneOneOne/OneOneOne_Male_AP_Left')
                    OOO_model_ML = keras.models.load_model('Results/OneOneOne/OneOneOne_Male_ML_Left')
                    OOO_model_V = keras.models.load_model('Results/OneOneOne/OneOneOne_Male_V_Left')
